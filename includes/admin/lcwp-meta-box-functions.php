<?php
/**
* Loyalty Card for WordPress Meta Box Functions
*
 ...
 * @param array $field
 */
function lcwp_wp_text_input( $field ) {
	...
	if ( ! empty( $field['description'] ) ) {
		...
		if ( isset( $field['desc_tip'] ) && false !== $field['desc_tip'] ) {
			echo '<img class="help_tip" data-tip="' . esc_attr( $field['description'] ) . '" src="' . esc_url( LCWP()->plugin_url() ) . '/assets/images/help.png" height="16" width="16" />';
		} else {
 ...
 * @param array $field
 */
function lcwp_wp_hidden_input( $field ) {
	global $thepostid, $post;
 ...
 * @param array $field
 */
function lcwp_wp_checkbox( $field ) {
	global $thepostid, $post;
